function spawnFishL(){
        if (frameCount%20===0){
          fishL = createSprite(-20,random(400,innerHeight-120));
          fishL.velocityX = 35;
          fishL.scale = 0.2;
          fishL.lifetime = 1000;
        ...
        function spawnFishR(){
         if (frameCount%25===0){
           fishR = createSprite(5100,random(400,innerHeight-120));
           fishR.velocityX = -35;
           fishR.scale = 0.2;
           fishR.lifetime = 1000;
        ...
        function spawnTrashL(){
         if (frameCount%15===0){
           trashL = createSprite(-10,random(400,innerHeight-120));
           trashL.velocityX = 27;
           trashL.scale = 0.1;
           trashL.lifetime = 800;
        ...
        function spawnTrashR(){
         if (frameCount%17===0){
           trashR = createSprite(5100,random(400,innerHeight-120));
           trashR.velocityX = -33;
           trashR.scale = 0.1;
           trashR.lifetime = 800;
